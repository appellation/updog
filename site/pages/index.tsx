			...
			<CenterCard>
				...
				>
					{(rooms: string[]) =>
						rooms.length > 0 ? (
							<Link
								className="text-lg text-gray-500 hover:text-gray-700 font-semibold flex flex-row items-center"
								href="/rooms"
							>
								your rooms
				...
				<form
					onSubmit={async (event) => {
						...
						try {
							const res = await fetch.post("/rooms", {
				...
				<div className="flex flex-row justify-end content-center mt-4 text-gray-400 space-x-3">
					<a
						...
						href="https://github.com/appellation/updog"
						rel="noreferrer"
						target="_blank"
					>
