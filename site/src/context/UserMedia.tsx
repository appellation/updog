...
const createMediaStore = (getMedia: () => Promise<MediaStream>) =>
	create<MediaState>((set, get) => ({
		isEnabled() {
...
export const useCamera = createMediaStore(async () =>
	navigator.mediaDevices.getUserMedia({ video: true })
);

export const useScreen = createMediaStore(async () =>
...
export const useMic = createMediaStore(async () =>
